...
if __name__ == "__main__":
    ...
    toSave = np.array([[0, 2], [2, 0], [0, -2]])
    from pylab import imread
    A = 256 * imread("D:/Projekty/SlotGenerator/classes/stl_tools-master/examples/example_data/NASA.png")
    A = A[:, :, 2] + 1.0 * A[:, :, 0]  # Compose RGBA channels to give depth

    numpy2stl(A, 'D:\Projekty\SlotGenerator\classes\stlTesting\stl_test.stl')
